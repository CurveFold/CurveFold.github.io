fetch("https://api.github.com/users/CurveFold/repos").then(data => data.json()).then(data => {
  ...
  fetch("https://api.github.com/users/CurveFold").then(about => about.json()).then(about => {
